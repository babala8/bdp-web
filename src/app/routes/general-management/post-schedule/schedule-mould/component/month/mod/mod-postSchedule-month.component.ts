...
@Component({
  selector: 'app-mod-postSchedule-month',
  templateUrl: './mod-postSchedule-month.component.html',
  styles: [`
        form>div {
            padding: 8px 0;
        }
...
export class ModPostScheduleMonthComponent implements OnInit {
  validateForm;
  loading = false;
  formModel = {};
  ...
  ngOnInit() {
    ...
    this.data.detailList.forEach(detail => {
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 8) {
        let opList18 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList18.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 8) {
        let opList28 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList28.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 8) {
        let opList38 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList38.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 9) {
        let opList19 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList19.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 9) {
        let opList29 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList29.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 9) {
        let opList39 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList39.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 10) {
        let opList110 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList110.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 10) {
        let opList210 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList210.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 10) {
        let opList310 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList310.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 11) {
        let opList111 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList111.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 11) {
        let opList211 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList211.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 11) {
        let opList311 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList311.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 12) {
        let opList112 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList112.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 12) {
        let opList212 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList212.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 12) {
        let opList312 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList312.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 13) {
        let opList113 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList113.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 13) {
        let opList213 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList213.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 13) {
        let opList313 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList313.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 14) {
        let opList114 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList114.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 14) {
        let opList214 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList214.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 14) {
        let opList314 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList314.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 15) {
        let opList115 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList115.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 15) {
        let opList215 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList215.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 15) {
        let opList315 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList315.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 16) {
        let opList116 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList116.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 16) {
        let opList216 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList216.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 16) {
        let opList316 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList316.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 17) {
        let opList117 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList117.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 17) {
        let opList217 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList217.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 17) {
        let opList317 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList317.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 18) {
        let opList118 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList118.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 18) {
        let opList218 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList218.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 18) {
        let opList318 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList318.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 19) {
        let opList119 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList119.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 19) {
        let opList219 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList219.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 19) {
        let opList319 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList319.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 20) {
        let opList120 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList120.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 20) {
        let opList220 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList220.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 20) {
        let opList320 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList320.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 21) {
        let opList121 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList121.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 21) {
        let opList221 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList221.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 21) {
        let opList321 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList321.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 22) {
        let opList122 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList122.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 22) {
        let opList222 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList222.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 22) {
        let opList322 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList322.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 23) {
        let opList123 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList123.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 23) {
        let opList223 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList223.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 23) {
        let opList323 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList323.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 24) {
        let opList124 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList124.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 24) {
        let opList224 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList224.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 24) {
        let opList324 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList324.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 25) {
        let opList125 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList125.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 25) {
        let opList225 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList225.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 25) {
        let opList325 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList325.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 26) {
        let opList126 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList126.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 26) {
        let opList226 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList226.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 26) {
        let opList326 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList326.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 27) {
        let opList127 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList127.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 27) {
        let opList227 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList227.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 27) {
        let opList327 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList327.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 28) {
        let opList128 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList128.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 28) {
        let opList228 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList228.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 28) {
        let opList328 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList328.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 29) {
        let opList129 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList129.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 29) {
        let opList229 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList229.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 29) {
        let opList329 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList329.push(op);
      ...
      }else if(detail.classesNo == "1" && detail.countNo == 30) {
        let opList130 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList130.push(op);
      ...
      }else if(detail.classesNo == "2" && detail.countNo == 30) {
        let opList230 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList230.push(op);
      ...
      }else if(detail.classesNo == "3" && detail.countNo == 30) {
        let opList330 = [];
        detail.opList.forEach(element => {
          let op = {"userName" : element.opNo, "name" : "nihao"};
          opList330.push(op);
