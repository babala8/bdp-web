...
import { DelayInterceptor } from '@core/net/delay.interceptor';
...
import { ShufflingDataService } from './routes/lazy/shufflingData.service';
...
@NgModule({
  ...
  imports: [
    ...
    BaiduMapModule.forRoot({
      ak: 'NkAm8rPyta0OEtPOK92RMPyqMU1GvFc3'
    }),
  ],
  providers: [
    ...LANG_PROVIDES,
